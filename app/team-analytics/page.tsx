    ...
    <main className="min-h-screen bg-background py-6 sm:py-8 lg:py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-muted-foreground">Comprehensive team statistics and performance data</p>
        </div>

        {/* Team Selection */}
        {teams.length > 0 ? (
          <div>
            {/* Render dynamically if teams exist */}
          </div>
        ) : (
          <div className="rounded-xl border border-dashed border-border/40 bg-card/10 p-8 text-center text-xs text-muted-foreground flex flex-col items-center justify-center gap-2">
            ...
            <p className="font-bold">No team analytics registered</p>
            <p className="opacity-75">Team telemetry will synchronize on match kickoff</p>
          </div>
        )}
