  ...
  return (
    <main className="min-h-screen bg-background py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-foreground">Role-Based Access Control</h1>
          <p className="mt-2 text-lg text-muted-foreground">Permissions and role hierarchy management</p>
        </div>

        {/* Permission Matrices Empty state */}
        <div className="rounded-xl border border-dashed border-border/40 bg-card/10 p-8 text-center text-xs text-muted-foreground flex flex-col items-center justify-center gap-2 mb-8">
          ...
          <p className="font-bold">No roles or permissions assigned</p>
        </div>
      </div>
    </main>
  )
